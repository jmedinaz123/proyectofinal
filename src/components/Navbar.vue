<template>
  <nav class="navbar px-0 bg-transparent justify-content-between">
    <svg xmlns="http://www.w3.org/2000/svg" width="184.284" height="33.008" viewBox="0 0 184.284 33.008">
      <g id="Grupo_17590" data-name="Grupo 17590" transform="translate(-86 -13.992)">
    ...
    <div>
      <router-link to='/' class="navbar-toggler">
        <span class="text-white"><i class="fas fa-shopping-cart"></i></span>
      </router-link>
      <button class="navbar-toggler toggler-example" type="button" data-toggle="collapse" data-target="#navbarSupportedContent1"
          aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation"><span class="text-white"><i
